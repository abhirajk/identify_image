...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '-m',
      '--model_file',
      default='/home/pi/identify_image/models/mobilenet_v1_1.0_224/mobilenet_v1_1.0_224.tflite',
      help='.tflite model to be executed')
  parser.add_argument(
      '-l',
      '--label_file',
      default='/home/pi/identify_image/models/mobilenet_v1_1.0_224/labels/labels.txt',
